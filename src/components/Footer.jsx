...
export default function Footer() {
  return (
    <footer className='dark:bg-blue-950 bg-[#E9ECEF]'>
      <div className="container">
        <div className='flex items-center gap-30 mt-20'>
          ...
          <div className='flex flex-col gap-3'>
            <p className='dark:text-white text-[16px] font-bold text-[#26282A]'>Xizmat haqida</p>
          ...
          <div className='flex flex-col gap-3'>
            <p className='dark:text-white text-[16px] font-bold text-[#26282A]'>Resurslar</p>
        ...
        <div className='flex items-center justify-between py-6 border-t mt-26.5 dark:text-white'> 
          <div>
