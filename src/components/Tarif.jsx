...
export default function Tarif({ name, monthly, summa }) {
    const prompts = [
    ...
    return (
        <div className="max-w-95 border border-[#BFC2C6] rounded-2xl hover:shadow-xl cursor-pointer dark:hover:shadow-xl shadow-[#174880] transition-shadow duration-300">
            <div className="px-8 py-6">
                ...
                <div className="flex flex-col items-start mt-6">
                    ...
                    <p className="text-[#7D8288] text-[16px] font-sans dark:text-[#A1A5AA]">{summa}</p>
                </div>
