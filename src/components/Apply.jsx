    ...
    <section className="pt-12">
      <form className="container">
        <div className="flex flex-col items-center px-5">
          <motion.h2
            {...animateText(-20, 0, 0, 0.8, 1)}
            className="text-3xl font-bold text-[#18191B]">
            Ariza yuborish
          </motion.h2>
          ...
          <div className="max-w-211.5 mt-8">
            ...
            <motion.button
              {...animateWhileInView(20, 0, 0, 0.8, 1)}
              type="submit" className="w-full py-4 bg-[#174880] text-sm font-bold cursor-pointer text-white mt-8 rounded-md hover:bg-[#2d629e]">
              Ariza yuborish
            </motion.button>
          </div>
        </div>
